	...
	<div id="page">
		...
		<div class="container-wrap">
			<div id="fh5co-work">
				...
				<form action="../Negocio/acciones/nuevaMascota.php" method="POST">
					<div class="row">
						<div class="col-xs-4">
							<label for="nombre">Nombre: </label>
						</div>
						<div class="col-xs-4">
							<input type="text" pattern="[a-zA-Z ]{3,250}" name="nombre" id="nombre" required>
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<input type="text" pattern="[a-zA-Z ]{3,250}" name="especie" id="especie" required>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<input type="text" pattern="[a-zA-Z ]{3,250}" name="raza" id="raza" required>
						</div>
					</div>
