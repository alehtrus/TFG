				...
				<form action="#">
					<div>
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<input type="text" name="nombre" placeholder="Nombre" style="border: 0px;">
							</div>
						</div>
					</div>
					<div>
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<input type="email" name="email" placeholder="portaldelpeludo@gmail.com" style="border: 0px;">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-4">
							...
							<div class="col-xs-4">
								<input type="tel" name="telefono" placeholder="687 21 76 32" style="border: 0px;">
							</div>
						</div>
					</div>
					<div>
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<input type="text" name="direccion" placeholder="direccion" style="border: 0px;">
							</div>
						</div>
					</div>
					<div>
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<input type="password" name="contrasena" placeholder="contrasena" style="border: 0px;">
							</div>
						</div>
					</div>
					<div>
